...
class UserInput(BaseModel):
    ...
    city: Annotated[str, Field(..., description='The city the the user belongs')]
    occupation: Annotated[Literal['retired', 'freelance', 'student', 'government_job', 'business_owner', 'unemployed', 'private_job'], Field(..., description='Occupation of the user')]
